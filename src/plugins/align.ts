...
export function alignCenterH(canvas: Canvas): void {
  const objs = getMultiSelectObjs(canvas)
  if (!objs.length) return
...
export function alignCenterV(canvas: Canvas): void {
  const objs = getMultiSelectObjs(canvas)
  if (!objs.length) return
...
export function sameWidth(canvas: Canvas): void {
  const objs = getMultiSelectObjs(canvas)
  if (!objs.length) return
...
export function sameHeight(canvas: Canvas): void {
  const objs = getMultiSelectObjs(canvas)
  if (!objs.length) return
