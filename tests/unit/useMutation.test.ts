/**
 * useMutation 单元测试 — 覆盖 commit 事务编排（issue #19 P0）
 *
...
describe('useMutation', () => {
  it('commit 应执行 fn、保存历史快照、刷新图层列表', () => {
    const canvas = {}
    ...
    expect(historyMgr.save).toHaveBeenCalledWith(canvas)
